...
test('should log request and response', async t => {
  ...
  const expectedPreMessage = 'Sending POST http://api1.test/Economy/InvoiceOrder/V001/InvoiceService.asmx'
  ...
  const expectedPostMessage = 'Success from POST http://api1.test/Economy/InvoiceOrder/V001/InvoiceService.asmx'
...
test('should log error response', async t => {
  ...
  const expectedPostMessage = 'Error from POST http://api2.test/Economy/InvoiceOrder/V001/InvoiceService.asmx: notfound'
  const expectedPostMeta = {
    status: 'notfound',
    error: 'Could not find \'http://api2.test/Economy/InvoiceOrder/V001/InvoiceService.asmx\': HTTPError: Response code 404 (Not Found)'
  }
