...
test('should override entire soapAction', async (t) => {
  ...
  const request = {
    ...
    endpoint: {
      ...
      requestPath: 'GetPaymentMethodsResponse.GetPaymentMethodsResult',
      namespace: 'http://example.com/webservices',
      soapAction: 'http://example.com/stupidOtherNamespace/And_GetPaymentMethodsResponse'
    },
    params: {}
  }
  const expectedAction = 'http://example.com/stupidOtherNamespace/And_GetPaymentMethodsResponse'
